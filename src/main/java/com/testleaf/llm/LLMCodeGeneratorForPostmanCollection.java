...
public class LLMCodeGeneratorForPostmanCollection {

    private final String systemPrompt = "You are a helpful assistant that generates complete Java automation test code for The CAT APIs. " +
    ...
    public CodeGenerationResponse generateCompleteCodeforPostmanCollection(String apiDetails, List<String> testTypes) {
    ...
    public CodeGenerationResponse generateCompleteCodeforPostmanCollection(String apiDetails) {
        return generateCompleteCodeforPostmanCollection(apiDetails, new ArrayList<>());
    }
    ...
    private String buildUserPrompt(String apiDetails) {
        return "Instruction:\n" +
            "Using the given parsed Postman Collection API details, generate complete RestAssured test code.\n\n" +
            "Context:\n" +
            "The provided details include title, version, description, servers, paths, and components/schemas. " +
            "Do not hardcode resource names; use generic names like 'Resource'.\n\n" +
            "Required Output:\n" +
            "1) A Gherkin Feature File containing a scenarios for testing a resource with valid data.\n" +
